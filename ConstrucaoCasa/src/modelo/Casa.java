...
public class Casa {
    ...
    public ArrayList<Aberturas> gertListaDeJanelas() {
    ...
    public void constroirCasa(String descricao, String cor, ArrayList<Aberturas> listaDePortas, ArrayList<Aberturas> listaDeJanelas) {
